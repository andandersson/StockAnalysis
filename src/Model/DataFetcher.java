...
public class DataFetcher {
	...
	/*
	 * This class is fetching the data from the csv file, converting it to String,
	 * and storing it in a string array. it is also transforming the data to
	 * different outputs
	 * 
	 * 
	 */
	...
	public String[][] createStockArray(StringBuffer str) {
		...
		while (count < data.length()) {
			String temp = Character.toString(data.charAt(count)); // string where we store a copy of cuurrent index
																	// value
			if (!temp.equals(" ")) {
